...
public class MessageLoginHttpUtil {

    public String phoneNum;

    public MessageLoginHttpUtil(){}

    public MessageLoginHttpUtil(String phoneNum){
            ...
            public void run() {
                try {
                    ...
                    Request request = new Request.Builder()
                            // 指定访问的地址
                            .url("http://47.103.214.166:8080/iHelpWeb/user/messageLogin/?phone="+phoneNum)
                            .build();
                    //接受返回的信息并进行处理
